...
public class SyncDiffAttributeEvent extends EventObject {

  private final SyncFile file;
  
  public SyncDiffAttributeEvent(final Object source, final SyncFile file) {
    super(source);
    if( file == null ) {
      throw new NullPointerException("sync file");
    }
    this.file = file;
  }
