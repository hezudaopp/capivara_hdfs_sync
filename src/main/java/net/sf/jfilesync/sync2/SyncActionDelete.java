 ...
 *
 * $Id: SyncActionDelete.java,v 1.8 2006/08/09 22:18:40 hunold Exp $
 */
...
public class SyncActionDelete extends SyncAction {

  public SyncActionDelete(SyncFile file) {
    super(file);
  }
  
  public String getActionName() {
    return LanguageBundle.getInstance().getMessage("sync.action.names.delete");
  }

  public void renderFileName(JLabel label) {
    label.setForeground(
        SyncColorSet.getColor(SyncColorSet.COLOR_ACTION_DELETE));
  }
