 ...
 *
 * $Id: Sha1SyncMethod.java,v 1.6 2006/03/04 12:51:55 hunold Exp $
 */
...
public class Sha1SyncMethod implements SyncMethod {

  public SyncAttributeComparator getSyncAttributeComparator() {
    return new Sha1SyncAttributeComparator();
  }
  ...
  public int getMethodID() {
    return SyncMethod.METHOD_SHA1;
  }

  public String getMethodDescription() {
    return "synchronize by comparing SHA-1 hash";
  }
