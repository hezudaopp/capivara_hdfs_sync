...
public class UnifyFileTreeView extends BasicFileTreeView {

  public UnifyFileTreeView(BasicFileTree fileTree, BasicFileTreeRenderer renderer) {
    super(fileTree, renderer);
  }
