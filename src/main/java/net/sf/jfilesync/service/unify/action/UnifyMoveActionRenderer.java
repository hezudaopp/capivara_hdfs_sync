...
public class UnifyMoveActionRenderer implements UnifyActionRenderer {

  public JComponent render(final UnifyAction action) {
    ...
    lab1.setText(action.getUnifyFile().getRelativePathToRoot());
