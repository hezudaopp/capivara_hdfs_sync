...
public abstract class AbstractFileFactory {
  ...
  public abstract BasicFile createBasicFile(TFileProperties file);

  public abstract BasicFileTree createBasicFileTree(BasicFile file);

  public BasicFile createDummyRoot(String path) {
    TFileProperties dummy = new TFileProperties();
    dummy.setAbsoluteFileName(path);
    dummy.setFileName(path);
    dummy.setDirectoryFlag(true);
    return createBasicFile(dummy);
  }
